...
\newcommand{\varShowToTables}					{true} % (true|false) opt. overwritten by variables-theme.tex

% PAPER FORMAT AND MARGINS
\newcommand{\varPaperWidth}			{21cm} %	 = 8.3in, % alt. use inch, same thing
\newcommand{\varPaperHeight}		{29.7cm} % = 11.7in, % alt. use inch, same thing
\newcommand{\varBindingOffset}	{1cm}
\newcommand{\varMarginTop}					{3cm} % measurement excluding header!
\newcommand{\varMarginBottom}				{3cm}
\newcommand{\varMarginLeft}					{2.5cm}
\newcommand{\varMarginRight}				{2.5cm}
...
\newcommand{\varFigWidth}{text} % (text|paper|0.x) 0.x like 0.5 = half text width
