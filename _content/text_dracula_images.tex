\section{Some images coming up...}

%include image as figure
...
%\renewcommand{\varWrapText}{true} % (true|false) wrap text around image?
%\renewcommand{\varFigWidth}{0.35} % (text|paper|0.x) 0.x like 0.5 = half text width
%\renewcommand{\varFigFloat}{r} % (r|R|l|L|i|I|o|O) only if WrapText http://ctan.org/pkg/wrapfig
\input{LaTeX/figure_snippet.tex}
...
%\adjincludegraphics[width=\ifdim\width>\linewidth \linewidth\else\width\fi]{_content/Dracula_Bela_Lugosi-295x384.jpg}
%\caption{MWE to demonstrate how to place to images side-by-side}
%\end{figure}

%\Figure[width=5cm,caption={An image}]{_content/Dracula_Bela_Lugosi-295x384.jpg}

%\begin{figure}
%\includegraphics[width=.48\linewidth]{example-image-a.jpg}\hfill
...
%\renewcommand{\varWrapText}{true} % (true|false) wrap text around image?
%\renewcommand{\varFigWidth}{0.35} % (text|paper|0.x) 0.x like 0.5 = half text width
%\renewcommand{\varFigFloat}{l} % (r|R|l|L|i|I|o|O) only if WrapText http://ctan.org/pkg/wrapfig
\input{LaTeX/figure_snippet.tex}
...
%include image as figure
\renewcommand{\varCaption}{John Van Eyssen as Jonathan Harker in Dracula, released in the United States as Horror of Dracula, 1958.}
\renewcommand{\varImgPath}{_content/Dracula_John_Van_Eyssen_as_Jonathan_Harker-608x336.jpg}
%\renewcommand{\varWrapText}{false} % (true|false) wrap text around image?
%\renewcommand{\varFigWidth}{paper} % (text|paper|0.x) 0.x like 0.5 = half text width
%\renewcommand{\varFigFloat}{l} % (r|R|l|L|i|I|o|O) only if WrapText http://ctan.org/pkg/wrapfig
\input{LaTeX/figure_snippet.tex}
...
%include image as figure
\renewcommand{\varCaption}{First test image paper width ImgTest 1440x1086 jpg}
...
%\renewcommand{\varWrapText}{false} % (true|false) wrap text around image?
%\renewcommand{\varFigWidth}{text} % (text|paper|0.x) 0.x like 0.5 = half text width
%\renewcommand{\varFigFloat}{l} % (r|R|l|L|i|I|o|O) only if WrapText http://ctan.org/pkg/wrapfig
\input{LaTeX/figure_snippet.tex}
